...
class EncoderLayer(nn.Module):
    def __init__(self, attention, d_model, d_ff=None, dropout=0.1, activation='relu'):
        ...
        self.conv1 = nn.Conv1d(in_channels=d_model, out_channels=d_ff, kernel_size=1) #선형변환
        self.conv2 = nn.Conv1d(in_channels=d_ff, out_channels=d_model, kernel_size=1) #후에 차원 복원 
